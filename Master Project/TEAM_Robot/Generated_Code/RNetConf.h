...
#define RNET_CONFIG_NRF24_DATA_RATE  (RF1_RF_SETUP_RF_DR_2000)
...
#define RNET_CONFIG_SMAC_OUPTUT_POWER  (RF1_RF_SETUP_RF_DR_2000)
  /*!< default transceiver data rate */
#endif
...
#define RNET_CONFIG_MSG_QUEUE_PUT_BLOCK_TIME_MS   (400/portTICK_PERIOD_MS)
