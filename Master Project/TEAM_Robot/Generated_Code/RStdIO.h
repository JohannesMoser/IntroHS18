...
extern uint8_t RSTDIO_DefaultShellBuffer[CLS1_DEFAULT_SHELL_BUFFER_SIZE]; /* default buffer which can be used by the application */

extern CLS1_ConstStdIOType RSTDIO_stdio; /* default standard I/O */
