 ...
 */
//#define REF_SENSOR_REFL_MAX_US	800
//#define REF_CNT_MAX_VAL
#define REF_CNT_MAX_VAL		(40000* (RefCnt_CNT_INP_FREQ_U_0/1000000))
...
//(0xbbb0)	//	//(0xbbb0)		// Counter zählt maximal bis 48'000	--> (RefCnt_CNT_INP_FREQ_U_0*(REF_SENSOR_REFL_MAX_US/1000/1000)) so eingeben anstatt hardcoded
